    ...
    dashboardBody(
      ...
      fluidRow(
        box(status = "success",
            ...
            h5(
              "Welcome to", strong("AgingPred!"),br(), "AgingPred was developed using Shiny that allows users to upload human peripheral blood RNA-seq data and predict the age and aging rate of the uploaded samples using our pre-built random forest age prediction model. (Please be aware that the analysis results are intended for scientific research purposes only. )", 
              br(), br(),
              ...
              ", ",
              tags$a(href = "https://www.genecards.org/cgi-bin/carddisp.pl?gene=PHGDH", "PHGDH"),
              ", ",
              ...
              "Please cite XXXXX articles after using this software.",
